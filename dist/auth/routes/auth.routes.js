...
router.post("/auth/register", authController.processSignUp.bind(authController));
router.post("/auth/logout", authController.processLogOut.bind(authController));
router.post("/auth/refresh", authController.renewAccessToken.bind(authController));
